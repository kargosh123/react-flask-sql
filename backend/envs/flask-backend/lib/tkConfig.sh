...
# installed.
TK_PREFIX='/Users/atierno/miniforge3/envs/flask-backend'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/atierno/miniforge3/envs/flask-backend'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/atierno/miniforge3/envs/flask-backend/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/atierno/miniforge3/envs/flask-backend/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/atierno/miniforge3/envs/flask-backend/include'
...
# compiled.
TK_SRC_DIR='/Users/atierno/miniforge3/envs/flask-backend/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/atierno/miniforge3/envs/flask-backend/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/atierno/miniforge3/envs/flask-backend/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/atierno/miniforge3/envs/flask-backend/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/atierno/miniforge3/envs/flask-backend/lib/libtkstub8.6.a'
